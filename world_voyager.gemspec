...
require_relative 'lib/world_voyager/version'

Gem::Specification.new do |spec|
  spec.name = 'world_voyager'
  spec.version = WorldVoyager::VERSION
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/rpbarata/world_voyager'
  spec.metadata['changelog_uri'] = 'https://github.com/rpbarata/world_voyager'
